...
cmdRpc1Received = Command
  ...
  , _cmdClientId = nodeIdClient
  , _cmdRequestId = RequestId 0
  , _cmdProvenance = ReceivedMsg {_pDig = Digest {_digNodeId = NodeID {_host = "localhost", _port = 10002}, _digSig = Signature {unSignature = "G\204\&6\242\t%\186\US*2\ENQ\146\218\235\ESCf!\138\211\204\EOT\227!\182tH',\215\ENQI\DC1\143\187N.\187\SYNi\DC2\154\234\130\249\237\193Uk\ETB\SUB)b\143\&0M_\188\137\158\"\\\212\132\ACK"}, _digPubkey = PublicKey {unPublicKey = "[\DC4\228\242  \209A\161\219\179\223(ty\FS$!{(\230\DC4V\184~\133>\255|\RS,\231"}, _digType = CMD}, _pOrig = "\NUL\NUL\NUL\NUL\NUL\NUL\NUL\DC1CreateAccount foo\NUL\NUL\NUL\NUL\NUL\NUL\NUL\tlocalhost\NUL\NUL\NUL\NUL\NUL\NUL'\DC2\NUL\NUL\NUL\NUL\NUL\NUL\NUL\NUL", _pTimeStamp = Nothing}}
...
-- aeRpcReceived = (\(Right v) -> v :: AppendEntries) $ fromWire Nothing keySet aeSignedRPC
...
aeEmptyRpcReceived = AppendEntries
  ...
  , _aeEntries = Seq.empty
  , _aeQuorumVotes = Set.empty
  , _aeProvenance = ReceivedMsg {_pDig = Digest {_digNodeId = NodeID {_host = "localhost", _port = 10000}, _digSig = Signature {unSignature = "e\206\214?\v\DC3nr\184\SUB\191\236\136\225\142Rm\146X\146=\131\144W\169\231\EMo\f\206\175\143\US\220Ny\FS`V\217\182\176\216\245\179\247\147\NAK\221\EOT\180\231@.\EOT\184:!5A\128\160\151\SOH"}, _digPubkey = PublicKey {unPublicKey = "\199\NAK\238\171\\\161\222\247\186/\DC3\204Qqd\225}\202\150e~q\255;\223\233\211:\211\SUBT\145"}, _digType = AE}, _pOrig = "\NUL\NUL\NUL\NUL\NUL\NUL\NUL\NUL\NUL\NUL\NUL\NUL\NUL\NUL\NUL\tlocalhost\NUL\NUL\NUL\NUL\NUL\NUL'\DLE\255\255\255\255\255\255\255\255\NUL\NUL\NUL\NUL\NUL\NUL\NUL\NUL\NUL\NUL\NUL\NUL\NUL\NUL\NUL\NUL\NUL\NUL\NUL\NUL\NUL\NUL\NUL\NUL", _pTimeStamp = Nothing}}
...
class WireFormatCBOR a where
  ...
  fromWireCBOR :: Maybe ReceivedAt -> KeySet -> SignedRPC -> Either String a
